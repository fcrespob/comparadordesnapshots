...
public class J880GBT003ModuloTablaRealista implements Modulo {
	...
	public static J880GBT003ModuloTablaRealista INSTANCE = null;
	private FlujosProbables fpClone;

	public static J880GBT003ModuloTablaRealista getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new J880GBT003ModuloTablaRealista();
		}
		return INSTANCE;
	}
	...
	private void flujosProbablesBTI(Integer kmodalidad, Integer kgarantia, String kprestacion, String kprestacionGen,
		...
		// Para las bases tecnicas de SCR, se recuperan los flujos probables de BEL
	...
	public String getNombreServicio() {
		return ConstantesModulosGBT.MOD_TR;
	}
