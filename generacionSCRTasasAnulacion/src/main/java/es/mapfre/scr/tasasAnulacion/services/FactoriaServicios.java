package es.mapfre.scr.tasasAnulacion.services;
...
/**
 * Factor�a de Factor�as. Cada una de las factor�as de servicios ha de extender
 * esta clase.
 * 
 */
public abstract class FactoriaServicios<T extends Servicio> {
	...
	/**
	 * Constructor de la factor�a
	 * 
	 * @param clazz
	 *            La clase para la que se est� implementando la factor�a
	 */
	...
	private void init(final Class<T> clazz) {
		// Pide a la factor�a a implementar su mapa de servicios
	...
	/**
	 * Devuelve un Servicio en funci�n del nombre de servicio solicitado
	 * 
