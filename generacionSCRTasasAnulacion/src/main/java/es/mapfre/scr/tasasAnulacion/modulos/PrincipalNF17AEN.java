...
import es.mapfre.scr.tasasAnulacion.gestores.GestorFichaProceso;
...
import es.mapfre.scr.tasasAnulacion.utils.CargaDatos;
import es.mapfre.scr.tasasAnulacion.utils.ConstantesSolvencia;
import es.mapfre.scr.tasasAnulacion.utils.LoggerManager;

public class PrincipalNF17AEN {

	private static final String RUTA_BASE = "CATALOGOS";
	private static final String BT = ConstantesSolvencia.BT_NF17AEN;
	...
	public static void main(String[] args) {
		try {
			...
			ModuloSCRAN mod = new ModuloSCRAN();
