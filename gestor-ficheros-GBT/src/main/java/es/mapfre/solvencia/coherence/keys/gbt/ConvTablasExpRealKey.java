...
public class ConvTablasExpRealKey   {
	@PortableProperty(ConvTablasExpReal.IND_KBASETEC) private String kbasetec;
	@PortableProperty(ConvTablasExpReal.IND_KCOMPANIA) private int kcompania;
	@PortableProperty(ConvTablasExpReal.IND_KNEGOCIO) private String knegocio;
	@PortableProperty(ConvTablasExpReal.IND_KRIESGO) private String kriesgo;
	@PortableProperty(ConvTablasExpReal.IND_KSEXO) private String ksexo;
	@PortableProperty(ConvTablasExpReal.IND_KCATEG) private String kcateg;
	@PortableProperty(ConvTablasExpReal.IND_KEDADDESDE) private Integer kedaddesde;
	@PortableProperty(ConvTablasExpReal.IND_KMODALIDAD) private Integer kmodalidad;
	@PortableProperty(ConvTablasExpReal.IND_KFDESDE) private Timestamp kfdesde;
	...
	public ConvTablasExpRealKey(String kbasetec, int kcompania,
