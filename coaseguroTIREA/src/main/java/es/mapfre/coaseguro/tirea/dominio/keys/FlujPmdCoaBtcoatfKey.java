...
public class FlujPmdCoaBtcoatfKey implements Comparable<FlujPmdCoaBtcoatfKey> {
	...
	public FlujPmdCoaBtcoatfKey(Integer kmodalidad, Integer kgarantia, String kprestacion, Long kpoliza, Integer ksubpoliza, Integer kcertificado, Integer nsuscri, String bt, Timestamp fcierre) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmdCoaBtcoatfKey other = (FlujPmdCoaBtcoatfKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(FlujPmdCoaBtcoatfKey o) {
