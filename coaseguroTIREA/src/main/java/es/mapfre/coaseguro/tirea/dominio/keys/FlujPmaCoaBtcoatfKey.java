...
public class FlujPmaCoaBtcoatfKey implements Comparable<FlujPmaCoaBtcoatfKey> {
	...
	public FlujPmaCoaBtcoatfKey(Long kpoliza, Integer ksubpoliza, Integer nsuscri, String bt, Timestamp fcierre, String fdesde) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmaCoaBtcoatfKey other = (FlujPmaCoaBtcoatfKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(FlujPmaCoaBtcoatfKey o) {
