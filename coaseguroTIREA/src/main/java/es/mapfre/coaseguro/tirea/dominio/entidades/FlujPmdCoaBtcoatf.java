...
import es.mapfre.coaseguro.tirea.dominio.keys.FlujPmdCoaBtcoatfKey;
import es.mapfre.coaseguro.tirea.dominio.keys.FlujPMdCoaKey;

public class FlujPmdCoaBtcoatf implements EntidadBase<FlujPmdCoaBtcoatfKey> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmdCoaBtcoatf other = (FlujPmdCoaBtcoatf) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "FlujPmdCoaBtcoatf [kmodalidad=" + kmodalidad + ", kgarantia=" + kgarantia + ", kprestacion="
				+ kprestacion + ", fcierre=" + fcierre + ", bt=" + bt + ", kpoliza=" + kpoliza + ", ksubpoliza="
				+ ksubpoliza + ", nsuscri=" + nsuscri + ", kcertificado=" + kcertificado + ", pintertecnI1="
				+ pintertecnI1 + ", pintertecnI2=" + pintertecnI2 + ", pintertecnI3=" + pintertecnI3 + ", pintertecnI4="
				+ pintertecnI4 + ", pintertecnI5=" + pintertecnI5 + ", fecFinTramo1=" + fecFinTramo1 + ", fecFinTramo2="
				+ fecFinTramo2 + ", fecFinTramo3=" + fecFinTramo3 + ", fecFinTramo4=" + fecFinTramo4 + ", fecFinTramo5="
				+ fecFinTramo5 + ", fecIniTramo1=" + fecIniTramo1 + ", fecIniTramo2=" + fecIniTramo2 + ", fecIniTramo3="
				+ fecIniTramo3 + ", fecIniTramo4=" + fecIniTramo4 + ", fecIniTramo5=" + fecIniTramo5 + ", kcoase1="
				+ kcoase1 + ", kcoase2=" + kcoase2 + ", kcoase3=" + kcoase3 + ", kcoase4=" + kcoase4 + ", kcoase5="
				+ kcoase5 + ", kcoase6=" + kcoase6 + ", fecefecini=" + fecefecini + ", fecefecfin=" + fecefecfin
	...
	@Override
	public FlujPmdCoaBtcoatfKey getKey() {
		return new FlujPmdCoaBtcoatfKey(kmodalidad, kgarantia, kprestacion, kpoliza, ksubpoliza, kcertificado, nsuscri, bt, fcierre);
	}
