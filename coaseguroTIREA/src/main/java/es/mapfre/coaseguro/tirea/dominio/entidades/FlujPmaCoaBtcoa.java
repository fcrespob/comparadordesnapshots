...
public class FlujPmaCoaBtcoa implements EntidadBase<FlujPmaCoaBtcoaKey> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmaCoaBtcoa other = (FlujPmaCoaBtcoa) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	@Override
	public FlujPmaCoaBtcoaKey getKey() {
		return new FlujPmaCoaBtcoaKey(kpoliza, ksubpoliza, nsuscri, bt, fcierre, fdesde);
	}
