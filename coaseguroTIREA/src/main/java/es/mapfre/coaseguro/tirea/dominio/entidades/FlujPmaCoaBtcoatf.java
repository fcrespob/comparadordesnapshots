...
public class FlujPmaCoaBtcoatf implements EntidadBase<FlujPmaCoaBtcoatfKey> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmaCoaBtcoatf other = (FlujPmaCoaBtcoatf) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "FlujPMaCoaBtcoatf [fcierre=" + fcierre + ", fdesde=" + fdesde + ", bt=" + bt + ", kpoliza=" + kpoliza
	...
	@Override
	public FlujPmaCoaBtcoatfKey getKey() {
		return new FlujPmaCoaBtcoatfKey(kpoliza, ksubpoliza, nsuscri, bt, fcierre, fdesde);
	}
