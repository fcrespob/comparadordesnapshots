...
public class FlujPmaCoaBtcoaKey implements Comparable<FlujPmaCoaBtcoaKey> {
	...
	public FlujPmaCoaBtcoaKey(Long kpoliza, Integer ksubpoliza, Integer nsuscri, String bt, Timestamp fcierre, String fdesde) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPmaCoaBtcoaKey other = (FlujPmaCoaBtcoaKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(FlujPmaCoaBtcoaKey o) {
