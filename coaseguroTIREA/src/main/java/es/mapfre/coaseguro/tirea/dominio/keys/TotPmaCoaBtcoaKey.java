...
public class TotPmaCoaBtcoaKey implements Comparable<TotPmaCoaBtcoaKey> {
	...
	public TotPmaCoaBtcoaKey() {
		super();
	}
	
	public TotPmaCoaBtcoaKey(String bt, Timestamp fcierre, Long kpoliza, Integer ksubpoliza, Integer nsuscri) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotPmaCoaBtcoaKey other = (TotPmaCoaBtcoaKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(TotPmaCoaBtcoaKey o) {
