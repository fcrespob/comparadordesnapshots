...
public class TotPmaCoaBtcoatf implements EntidadBase<TotPmaCoaBtcoatfKey>{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotPmaCoaBtcoatf other = (TotPmaCoaBtcoatf) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "TotPmaCoaBtcoatf [fcierre=" + fcierre + ", bt=" + bt + ", kpoliza=" + kpoliza + ", ksubpoliza=" + ksubpoliza
	...
	@Override
	public TotPmaCoaBtcoatfKey getKey() {
		return new TotPmaCoaBtcoatfKey(bt, fcierre,kpoliza, ksubpoliza, nsuscri);
	}
