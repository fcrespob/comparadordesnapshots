...
import es.mapfre.scr.gastos.dominio.EntidadConBaseTec;
import es.mapfre.scr.gastos.dominio.keys.IncidenciaKey;
...
public class Incidencia implements EntidadConBaseTec {
	...
	public IncidenciaKey getKey() {
		return new IncidenciaKey(bt, generadorError, codigoRetorno, fecCierre);
	}
}
