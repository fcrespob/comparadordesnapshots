...
public class GastosReales implements EntidadBase<GastosRealesKey> {
	...
	public GastosRealesKey getKey() {
		return new GastosRealesKey(ccanal, cnegocio, fecDesde, fecHasta, kmodalidad, kramo, ktipobt);
	}
	...
	public int hashCode() { //NOSONAR
		...
		result = prime * result
				+ ((gastoPorUmic == null) ? 0 : gastoPorUmic.hashCode());
		result = prime
				* result
				+ ((gastosAdminContab == null) ? 0 : gastosAdminContab
						.hashCode());
		result = prime
				* result
				+ ((gastosAdminSinProv == null) ? 0 : gastosAdminSinProv
						.hashCode());
		result = prime * result
		...
		result = prime * result
				+ ((numUmicComprar == null) ? 0 : numUmicComprar.hashCode());
		result = prime * result
				+ ((numUmicRef == null) ? 0 : numUmicRef.hashCode());
		result = prime * result
				+ ((pctGastoProv == null) ? 0 : pctGastoProv.hashCode());
		result = prime * result
				+ ((provMatComparar == null) ? 0 : provMatComparar.hashCode());
		result = prime * result
				+ ((provMatRef == null) ? 0 : provMatRef.hashCode());
		return result;
	}
