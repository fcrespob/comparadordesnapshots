...
public class PrincipalNF17GRE {

	private static final String RUTA_BASE = "CATALOGOS";
	private static final String TIPO = ConstantesSolvencia.CTE_GTO_UMIC_NIIF17;
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				inci.setInfAmpliada("Error gen�rico en la lectura de ficheros.");
				gi.write(inci);
				gi.cerrarConector();
				System.exit(0);
			}
			...
			try{
				...
				inci.setInfAmpliada("Error gen�rico al obtener la fecha efecto.");
				gi.write(inci);
				gi.cerrarConector();
				System.exit(0);
			}
			...
			ModuloNF17GRE mod = new ModuloNF17GRE();
