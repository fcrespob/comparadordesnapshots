...
public class PrincipalSCRIPC {

	private static final String RUTA_BASE = "CATALOGOS";
	private static final String TIPO = ConstantesSolvencia.CTE_IPC;
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				inci.setInfAmpliada("Error gen̩rico en la lectura de ficheros.");
				gi.write(inci);
				gi.cerrarConector();
				System.exit(0);
			}
			...
			ModuloSCRIPC mod = new ModuloSCRIPC();
