...
import es.mapfre.scr.tablasExperiencia.dominio.EntidadConBaseTec;
import es.mapfre.scr.tablasExperiencia.dominio.keys.IncidenciaKey;
import es.mapfre.scr.tablasExperiencia.dominio.keys.UmicKey;

public class Incidencia implements EntidadConBaseTec {
