...
import es.mapfre.scr.tablasExperiencia.dominio.entidades.FichaResultado;
		...
		try {
			switch (bt) {
				case ConstantesSolvencia.BT_SCRMFE:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASMFE;
					break;
				case ConstantesSolvencia.BT_SCRMMI:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASMMI;
					break;
				case ConstantesSolvencia.BT_SCRMCF:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASMCF;
					break;
				case ConstantesSolvencia.BT_SCRMCI:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASMCI;
					break;
				case ConstantesSolvencia.BT_SCRLFE:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASLFE;
					break;
				case ConstantesSolvencia.BT_SCRLMI:
					rutaFicheroLog = ConstantesSolvencia.RUTA_BASE + File.separator + ConstantesSolvencia.LOG_FICHASLMI;
					break;
				default:
					break;
			}
