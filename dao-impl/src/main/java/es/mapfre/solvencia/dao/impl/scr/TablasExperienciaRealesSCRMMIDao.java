...
public class TablasExperienciaRealesSCRMMIDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "SCRMMI0"; 
	...
	public TablasExperienciaRealesSCRMMIDao() {
		super();
