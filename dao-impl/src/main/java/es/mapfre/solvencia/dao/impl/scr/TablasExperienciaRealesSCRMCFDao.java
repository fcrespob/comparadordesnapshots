...
public class TablasExperienciaRealesSCRMCFDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "SCRMCF0"; 
	...
	public TablasExperienciaRealesSCRMCFDao() {
		super();
