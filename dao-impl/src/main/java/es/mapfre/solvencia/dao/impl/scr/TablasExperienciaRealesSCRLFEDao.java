...
public class TablasExperienciaRealesSCRLFEDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "SCRLFE0"; 
	...
	public TablasExperienciaRealesSCRLFEDao() {
		super();
