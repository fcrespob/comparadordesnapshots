...
public class TablasExperienciaRealesNF17MFEDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "NF17MFE0"; 
	...
	public TablasExperienciaRealesNF17MFEDao() {
		super();
