...
public class TablasExperienciaRealesSCRLMIDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "SCRLMI0"; 
	...
	public TablasExperienciaRealesSCRLMIDao() {
		super();
