...
public class TablasExperienciaRealesSCRMCIDao extends DaoBase  implements Map<TablasExperienciaRealesKey, TablasExperienciaReales> {
		
	private static final String CACHE_NAME = "SCRMCI0"; 
	...
	public TablasExperienciaRealesSCRMCIDao() {
		super();
