...
public class BigDecimalAbsOutTypeHandler extends BigDecimalTypeHandler {
    ...
    public String format(Object value) {
    	...
    	if (value instanceof BigDecimal) {
    		...
    		if (decimales > MAXIMO_NUMERO_DECIMALES) {
    			// TODO Caso específico
    			return valor.toString();
    		}
    		return dfFormatter.format(valor.abs());
    	}
	...
	public TypeHandler newInstance(Properties arg0) {
		...
		BigDecimalAbsOutTypeHandler ddth = new BigDecimalAbsOutTypeHandler();
		...
		DecimalFormatSymbols custom = defFormatter.getDecimalFormatSymbols();
		custom.setDecimalSeparator(',');
		defFormatter.setDecimalFormatSymbols(custom);
