package es.mapfre.gbt.tablasExperiencia.dao.services;

import java.util.Map;

import es.mapfre.gbt.tablasExperiencia.dao.Dao;
import es.mapfre.gbt.tablasExperiencia.services.FactoriaServicios;
...
public class FactoriaDao extends FactoriaServicios<Dao> {
	...
	/**
	 * Devuelve un Dao en función del identificador de caché solicitado
	 * 
	 * @param idDao
