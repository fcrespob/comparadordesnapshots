...
import es.mapfre.gbt.tablasExperiencia.dominio.keys.FichaProcesoKey;
...
public class FichaProceso implements EntidadBase<FichaProcesoKey>{
	...
	private Timestamp fefecto;
	private Timestamp fprevejec;
	private Timestamp finiper;
	private String cnegocio;
	private Integer ccanal;
	private String ctipobt;
	private String gparametros;
	private String csituacion;
	private Timestamp finireal;
	private String ghinireal;
	private Timestamp ffinreal;
	private String ghfinreal;
	private String sokauto;
	private String sokusua;
	private String gobservacion;
	private String ctipoejec;
	private String smanual;
	private Timestamp fgrabacion;
	private String cusuario;
	private Timestamp fmodificacion;
	private String cusuariom;
	private String ktipoamb;

	private List<FiltroFichaProceso> filtrosAmbito = new ArrayList<FiltroFichaProceso>();
    // NUEVO
    private List<FiltroFichaProcesoAdicional> filtrosAdicionales = new ArrayList<FiltroFichaProcesoAdicional>();
    // FIN NUEVO

	private RegistroParametros registroParametros;
	...
	public String toString() {
		...
		builder.append("FichaProcesoTExp [kejecucion=");
