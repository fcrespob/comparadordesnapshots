...
public class FlujosReales implements EntidadBase<FlujosRealesKey>{
	...
	public static final int IND_FILLERMVTO = 4;
	public static final int IND_CODCOB = 5;
	public static final int IND_CODCTORVA = 6;
	public static final int IND_CODPRODUCTOR = 7;
	public static final int IND_CLASEPRODUCTOR = 8;
	public static final int IND_CLASEMEDIADOR = 9;
	public static final int IND_TIPDOCUM = 10;
	public static final int IND_CODDOCUM = 11;
	public static final int IND_OFDIRECTA = 12;
	public static final int IND_CODTERCEROAGT = 13;
	public static final int IND_FECMOVEXP = 14;
	public static final int IND_TIPEXP = 15;
	public static final int IND_CODTIPCGRPTIPEXP = 16;
	public static final int IND_FECOCURSINI = 17;
	public static final int IND_FECAPERTEXP = 18;
	public static final int IND_REAPERTEXP = 19;
	public static final int IND_TERMEXP = 20;
	public static final int IND_CODMON = 21;
	public static final int IND_CLASEEXP = 22;
	public static final int IND_NUMPOLIZA = 23;
	public static final int IND_NUMAPLI = 24;
	public static final int IND_NUMRIESGO = 25;
	public static final int IND_MODALIDAD = 26;
	public static final int IND_CODRAMO = 27;
	public static final int IND_CODSECTOR = 28;
	public static final int IND_TIPCOA = 29;
	public static final int IND_TIPREA = 30;
	public static final int IND_PCTCOA = 31;
	public static final int IND_TIPOMOV = 32;
	public static final int IND_TIPOOPER = 33;
	public static final int IND_VALTITALRESERVAMES = 34;
	public static final int IND_PAGOANUAL = 35;
	public static final int IND_IMPORTEVALORACION = 36;
	public static final int IND_IMPORTEPAGO = 37;
	public static final int IND_FECMOVECO = 38;
	public static final int IND_CODMONPAGO = 39;
	public static final int IND_COHORTE = 40;
	public static final int IND_FECEFECTOINI = 41;
	public static final int IND_FECEFECTOSPTO = 42;
	public static final int IND_FECSUSCRIPCION = 43;
	public static final int IND_CODLOBBIS = 44;
	public static final int IND_PCTDESGLOSE = 45;
	public static final int IND_SISTEMA = 46;
	public static final int IND_CLAVEINCCORR = 47;
	public static final int IND_FECHAESTADO = 48;
	public static final int IND_MCAVIGENTE = 49;
	
	private Integer    codCia;
	private String     numExp;
	private Integer    anioMes;
	private Integer    numMvto;
	private Integer    fillerMvto;
	private Integer    codCob;
	private Long       codCtoRva;
	...
	private Timestamp       fecMovExp;
	private String     tipExp;
	private String     codTipcGrpTipExp;
	private Timestamp       fecOcurSini;
	private Timestamp       fecApertExp;
	private Timestamp       fecReapertExp;
	private Timestamp       fecTermExp;
	private String     codMon;
	private String     claseExp;
	private String     numPoliza;
	private Integer    numApli;
	...
	private BigDecimal valTotalReservaMes;
	private BigDecimal pagoAnual;
	private BigDecimal importeValoracion;
	private BigDecimal importePago;
	private Timestamp       fecMovEco;
	private String     codMonPago;
	private Integer    cohorte;
	private Timestamp       fecEfectoIni;
	private Timestamp       fecEfectoSpto;
	private Timestamp       fecSuscripcion;
	private String     codLobBis;
	private String     pctDesglose;
	private String     sistema;
	private Integer    claveIncCorr;
	private Timestamp       fechaEstado;
	private String     mcaVigente;
	
	@Override
	public FlujosRealesKey getKey() {
		return new FlujosRealesKey(codCia, numExp, anioMes, numMvto, codCob, codCtoRva);	
	}
	...
	public Integer getFillerMvto() {
		return fillerMvto;
	}
	public void setFillerMvto(Integer fillerMvto) {
		this.fillerMvto = fillerMvto;
	}
	...
	public Long getCodCtoRva() {
		return codCtoRva;
	}
	public void setCodCtoRva(Long codCtoRva) {
	...
	public Timestamp getFecMovExp() {
		return fecMovExp;
	}
	public void setFecMovExp(Timestamp fecMovExp) {
	...
	public Timestamp getFecOcurSini() {
		return fecOcurSini;
	}
	public void setFecOcurSini(Timestamp fecOcurSini) {
		this.fecOcurSini = fecOcurSini;
	}
	public Timestamp getFecApertExp() {
		return fecApertExp;
	}
	public void setFecApertExp(Timestamp fecApertExp) {
		this.fecApertExp = fecApertExp;
	}
	public Timestamp getFecReapertExp() {
		return fecReapertExp;
	}
	public void setFecReapertExp(Timestamp fecReapertExp) {
		this.fecReapertExp = fecReapertExp;
	}
	public Timestamp getFecTermExp() {
		return fecTermExp;
	}
	public void setFecTermExp(Timestamp fecTermExp) {
	...
	public Integer getNumApli() {
		return numApli;
	}
	public void setNumApli(Integer numApli) {
	...
	public BigDecimal getValTotalReservaMes() {
		return valTotalReservaMes;
	}
	public void setValTotalReservaMes(BigDecimal valTotalReservaMes) {
	...
	public void setImporteValoracion(BigDecimal importeValoracion) {
	...
	public Timestamp getFecMovEco() {
		return fecMovEco;
	}
	public void setFecMovEco(Timestamp fecMovEco) {
	...
	public Timestamp getFecEfectoIni() {
		return fecEfectoIni;
	}
	public void setFecEfectoIni(Timestamp fecEfectoIni) {
		this.fecEfectoIni = fecEfectoIni;
	}
	public Timestamp getFecEfectoSpto() {
		return fecEfectoSpto;
	}
	public void setFecEfectoSpto(Timestamp fecEfectoSpto) {
		this.fecEfectoSpto = fecEfectoSpto;
	}
	public Timestamp getFecSuscripcion() {
		return fecSuscripcion;
	}
	public void setFecSuscripcion(Timestamp fecSuscripcion) {
	...
	public Integer getClaveIncCorr() {
		return claveIncCorr;
	}
	public void setClaveIncCorr(Integer claveIncCorr) {
	...
	public int hashCode() {
		...
		result = prime * result + ((fillerMvto == null) ? 0 : fillerMvto.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujosReales other = (FlujosReales) obj;
		if (anioMes == null) {
		...
		if (numMvto == null) {
			...
			return false;
		if (fillerMvto == null) {
			if (other.fillerMvto != null)
				return false;
		} else if (!fillerMvto.equals(other.fillerMvto))
			return false;
		if (numPoliza == null) {
