package es.mapfre.proxy.prestaciones.dao;
...
public abstract class DaoBase implements Dao {
	...
	public DaoBase(){
		...
		if(singletonManager==null){
			InputStream config = ClassLoader.getSystemResourceAsStream("ehcacheConfig/ehcacheProxy.xml");
	...
	/**
	 * Asigna el nombre de la cach� a emplear
	 * 
	 * @param cacheName
	 */
	...
	/**
	 * @return la cach� de Coherence referenciada por el nombre
	 */
	...
	/**
	 * @return el tamaño en elementos de la cach�
	 */
	public int size() {
	 ...
	 * @return Si la clave est� presente en la cach�
	 */
	 ...
	 * @param value
	 *            El valor a buscar
	 * @return Si el valor est presente en la cach�
	 */
	...
	/**
	 * Limpia el contenido de la cach�
	 */
	public void clear() {
	...
	/**
	 * Carga la cach� empleando el lector de BeanIO pasado como par�metro. El
	 ...
	 * como par�metro. El writer ha de estar correctamente inicializado.
	 * 
	 * @param writer
	 */
