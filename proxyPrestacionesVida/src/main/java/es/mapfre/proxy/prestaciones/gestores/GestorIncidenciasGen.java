...
import es.mapfre.proxy.prestaciones.dominio.entidades.Incidencias;
...
public class GestorIncidenciasGen {
	...
	private GestorIncidenciasGen(){
		try {
			NOMBRE_FICH_INCIDENCIAS = ConstantesSolvencia.RUTA_BASE + ConstantesSolvencia.RUTA_FICHAS + btUtils.getCargaFicherosProperty(ConstantesSolvencia.CATALOGO_INC);
