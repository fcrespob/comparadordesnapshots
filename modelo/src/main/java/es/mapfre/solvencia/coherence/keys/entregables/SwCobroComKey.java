...
@Portable
public class SwCobroComKey implements Comparable<SwCobroComKey> {
	...
	public String toString() {
		return "SWCOBROCOMKey [kpoliza=" + kpoliza + ", ksubpoliza=" + ksubpoliza + "]";
	}
	...
	@Override
	public int compareTo(SwCobroComKey o) {
