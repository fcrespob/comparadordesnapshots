...
public class FichaProcesoKey {
	...
	@PortableProperty(FichaProceso.IND_KEJECUCION) private Integer kejecucion;
	@PortableProperty(FichaProceso.IND_KSISTEMA) private String ksistema;
	@PortableProperty(FichaProceso.IND_KPROTECNICO) private String kprotecnico;
	@PortableProperty(FichaProceso.IND_KUEJECUCION) private String kuejecucion;
	@PortableProperty(FichaProceso.IND_KSECUENCIA) private Integer ksecuencia;
