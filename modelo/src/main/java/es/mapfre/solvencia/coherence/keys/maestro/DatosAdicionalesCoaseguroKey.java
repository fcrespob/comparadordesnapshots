...
@Portable
public class DatosAdicionalesCoaseguroKey {

	@PortableProperty(DatosAdicionalesCoaseguro.IND_KPOLIZA)
	private Long kpoliza;
	@PortableProperty(DatosAdicionalesCoaseguro.IND_KSUBPOL)
	private Integer ksubpol;

	public DatosAdicionalesCoaseguroKey(Long kpoliza, Integer ksubpoliza) {
	...
	public boolean equals(Object obj) { //NOSONAR
		...
		DatosAdicionalesCoaseguroKey other = (DatosAdicionalesCoaseguroKey) obj;
		if (kpoliza == null) {
