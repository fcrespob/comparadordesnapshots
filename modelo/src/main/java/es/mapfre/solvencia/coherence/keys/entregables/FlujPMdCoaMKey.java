...
@Portable
public class FlujPMdCoaMKey implements Comparable<FlujPMdCoaMKey> {
	...
	public FlujPMdCoaMKey(Integer kmodalidad, Integer kgarantia, String kprestacion, Long kpoliza, Integer ksubpoliza, Integer kcertificado, Integer nsuscri, String bt, Timestamp fcierre) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPMdCoaMKey other = (FlujPMdCoaMKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(FlujPMdCoaMKey o) {
