...
@Portable
public class FlujInf4Key implements Comparable<FlujInf4Key> {

	@PortableProperty(FlujInf4.IND_BT)
	private String bt;
	@PortableProperty(FlujInf4.IND_FCIERRE)
	private Timestamp fcierre;
	@PortableProperty(FlujInf4.IND_CCANAL)
	private Integer ccanal;
	@PortableProperty(FlujInf4.IND_NEGOCIO)
	private String negocio;
	@PortableProperty(FlujInf4.IND_UOA)
	private String uoa;
	@PortableProperty(FlujInf4.IND_KCARTERA_CONTRATO)
	private String kcarteraContrato;
	@PortableProperty(FlujInf4.IND_KCARTERA_COHORT)
	private String kcarteraCohort;
	@PortableProperty(FlujInf4.IND_KCARTERA_ONER)
	private String kcarteraOner;
	@PortableProperty(FlujInf4.IND_FPROYFLUJEST)
	private Timestamp fproyflujest;
	@PortableProperty(FlujInf4.IND_KCARTERAINV)
	private String kcarterainv;
	@PortableProperty(FlujInf4.IND_KMODALIDAD)
	...
	public FlujInf4Key(String bt, Timestamp fcierre, Integer ccanal, String negocio, String uoa,
	...
	public String toString() {
		return "FlujInf4Key [bt=" + bt + ", fcierre=" + fcierre + ", ccanal=" + ccanal + ", negocio=" + negocio
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujInf4Key other = (FlujInf4Key) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public int compareTo(FlujInf4Key o) {
