...
@Portable
public class TotPMaCoaMKey implements Comparable<TotPMaCoaMKey> {
	...
	public TotPMaCoaMKey() {
		super();
	}
	
	
	public TotPMaCoaMKey(String bt, Timestamp fcierre, Long kpoliza, Integer ksubpoliza, Integer nsuscri) {
		this.bt = bt;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotPMaCoaMKey other = (TotPMaCoaMKey) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "TotPmaCoaMKey [bt=" + bt + ", feccierre=" + fcierre + ",  kpoliza=" + kpoliza
				+ ", ksubpoliza=" + ksubpoliza + ", nsuscri=" + nsuscri + "]";
	}
	
	public int compareTo(TotPMaCoaMKey o) {
