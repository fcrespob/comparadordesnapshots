...
@Portable
public class FlujPMdCoaM implements EntidadBase<FlujPMdCoaMKey>, EntidadConBaseTec {
	...
	private String totprovision;
	@PortableProperty(IND_GTOROSSP_CAP)
	private String gtorosspCap;
	@PortableProperty(IND_GTOROSSP_PRIMA)
	private String gtorosspPrima;
	@PortableProperty(IND_GTOROSSP_PROV)
	private String gtorosspProv;
	...
	private String rentini;
	@PortableProperty(IND_PGASTGESEX1I)
	private String pgastgesex1I;
	@PortableProperty(IND_PGASTGESEX2I)
	private String pgastgesex2I;
	@PortableProperty(IND_TOTFACTGTO)
	private String totfactgto;
	...
	@PortableProperty(IND_GEDADMAX)
	private Integer gedadmax;
	@PortableProperty(IND_PB)
	private String pb;
	@PortableProperty(IND_TIPOPB)
	...
	public String getTotprovision() {
		return totprovision;
	}

	public void setTotprovision(String totprovision) {
		this.totprovision = totprovision;
	}

	public String getGtorosspCap() {
		return gtorosspCap;
	}

	public void setGtorosspCap(String gtorosspCap) {
		this.gtorosspCap = gtorosspCap;
	}

	public String getGtorosspPrima() {
		return gtorosspPrima;
	}

	public void setGtorosspPrima(String gtorosspPrima) {
		this.gtorosspPrima = gtorosspPrima;
	}

	public String getGtorosspProv() {
		return gtorosspProv;
	}

	public void setGtorosspProv(String gtorosspProv) {
	...
	public String getIprimanetaact() {
		return iprimanetaact;
	}

	public void setIprimanetaact(String iprimanetaact) {
		this.iprimanetaact = iprimanetaact;
	}

	public String getIprimanetaini() {
		return iprimanetaini;
	}

	public void setIprimanetaini(String iprimanetaini) {
		this.iprimanetaini = iprimanetaini;
	}

	public String getIprimatarada() {
		return iprimatarada;
	}

	public void setIprimatarada(String iprimatarada) {
		this.iprimatarada = iprimatarada;
	}

	public String getIcapact() {
		return icapact;
	}

	public void setIcapact(String icapact) {
		this.icapact = icapact;
	}

	public String getIcapini() {
		return icapini;
	}

	public void setIcapini(String icapini) {
		this.icapini = icapini;
	}

	public String getIsaldo() {
		return isaldo;
	}

	public void setIsaldo(String isaldo) {
		this.isaldo = isaldo;
	}
	...
	public String getRentini() {
		return rentini;
	}

	public void setRentini(String rentini) {
		this.rentini = rentini;
	}

	public String getPgastgesex1I() {
		return pgastgesex1I;
	}

	public void setPgastgesex1I(String pgastgesex1i) {
		pgastgesex1I = pgastgesex1i;
	}

	public String getPgastgesex2I() {
		return pgastgesex2I;
	}

	public void setPgastgesex2I(String pgastgesex2i) {
		pgastgesex2I = pgastgesex2i;
	}

	public String getTotfactgto() {
		return totfactgto;
	}

	public void setTotfactgto(String totfactgto) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPMdCoaM other = (FlujPMdCoaM) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "FlujPMdCoaM [kmodalidad=" + kmodalidad + ", kgarantia=" + kgarantia + ", kprestacion=" + kprestacion
	...
	@Override
	public FlujPMdCoaMKey getKey() {
		return new FlujPMdCoaMKey(kmodalidad, kgarantia, kprestacion, kpoliza, ksubpoliza, kcertificado, nsuscri, bt, fcierre);
	}
