...
public class GastosReales implements EntidadBase<GastosRealesKey> {
	...
	@PortableProperty(IND_FECHASTA)
	private Timestamp fecHasta;
	@PortableProperty(IND_GASTOSADMINCONTAB)
	private java.math.BigDecimal gastosAdminContab;
	@PortableProperty(IND_GASTOSADMINSINPROV)
	private java.math.BigDecimal gastosAdminSinProv;
	@PortableProperty(IND_GASTOPORUMIC)
	...
	@PortableProperty(IND_KTIPOBT)
	private String ktipobt;
	@PortableProperty(IND_NUMUMICCOMPRAR)
	private Integer numUmicComprar;
	@PortableProperty(IND_NUMUMICREF)
	private Integer numUmicRef;
	@PortableProperty(IND_PCTGASTOPROV)
	private java.math.BigDecimal pctGastoProv;
	@PortableProperty(IND_PROVMATCOMPARAR)
	private java.math.BigDecimal provMatComparar;
	@PortableProperty(IND_PROVMATREF)
	private java.math.BigDecimal provMatRef;
	@PortableProperty(IND_MATCHING)
