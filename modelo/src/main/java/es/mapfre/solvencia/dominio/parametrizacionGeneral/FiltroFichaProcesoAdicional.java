...
public class FiltroFichaProcesoAdicional {
	...
	@PortableProperty(IND_KSECFIL)
	private Integer ksecfil;
	@PortableProperty(IND_CTIPOFILTRO)
	private String ctipofiltro;
	@PortableProperty(IND_GCLASEFIL)
	private String gclasefil;
	@PortableProperty(IND_GOPERDESDE)
	private String goperdesde;
	@PortableProperty(IND_VALORDESDE)
	private String valordesde;
	@PortableProperty(IND_GOPERHASTA)
	private String goperhasta;
	@PortableProperty(IND_VALHASTA)
	private String valhasta;
	@PortableProperty(IND_GOPDESDEGAR)
	private String gopdesdegar;
	@PortableProperty(IND_VALDESDEGAR)
	private String valdesdegar;
	@PortableProperty(IND_GOPHASTAGAR)
	private String gophastagar;
	@PortableProperty(IND_VALHASTAGAR)
	private String valhastagar;
	@PortableProperty(IND_SMANUAL)
	private String smanual;
	@PortableProperty(IND_CPOLIZA)
	private Long cpoliza;
	@PortableProperty(IND_NSUBPOLIZA)
	private String nsubpoliza;
	@PortableProperty(IND_SCASADOS)
	private String scasados;
	@PortableProperty(IND_CSEGMENTO)
	private String csegmento;
	@PortableProperty(IND_CRIESGOACT)
	private String criesgoact;
	@PortableProperty(IND_GTIPINTERES)
	private BigDecimal gtipinteres;
	@PortableProperty(IND_FGRABACION)
	private Timestamp fgrabacion;
	@PortableProperty(IND_CUSUARIOG)
	private String cusuariog;
	@PortableProperty(IND_FMODIFICA)
	private Timestamp fmodifica;
	@PortableProperty(IND_CUSUARIOM)
