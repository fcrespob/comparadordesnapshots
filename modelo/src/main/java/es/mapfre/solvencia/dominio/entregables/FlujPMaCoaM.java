...
@Portable
public class FlujPMaCoaM implements EntidadBase<FlujPMaCoaMKey>, EntidadConBaseTec {
	...
	@PortableProperty(IND_TOTFLUJOPROBSINGASTOS)
	private String totflujoprobsingastos;
	@PortableProperty(IND_TOTFLUJOPROBDEGASTOS)
	private String totflujoprobdegastos;
	...
	public String getTotflujoprobsingastos() {
		return totflujoprobsingastos;
	}

	public void setTotflujoprobsingastos(String totflujoprobsingastos) {
		this.totflujoprobsingastos = totflujoprobsingastos;
	}

	public String getTotflujoprobdegastos() {
		return totflujoprobdegastos;
	}

	public void setTotflujoprobdegastos(String totflujoprobdegastos) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujPMaCoaM other = (FlujPMaCoaM) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	@Override
	public FlujPMaCoaMKey getKey() {
		return new FlujPMaCoaMKey(kpoliza, ksubpoliza, nsuscri, bt, fcierre, fdesde);
	}
