...
@Portable
public class ContabilidadCertificado implements EntidadBase<ContabilidadCertificadoKey>, EntidadConBaseTec {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ContabilidadCertificado other = (ContabilidadCertificado) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	public String toString() {
		return "ContabilidadCertificado [bt=" + bt + ", feccierre=" + feccierre + ", ccanal=" + ccanal + ", kramo=" 
	...
	@Override
	public ContabilidadCertificadoKey getKey() {
		return new ContabilidadCertificadoKey(bt, ccanal, feccierre ,kramo, kmodalidad, kpoliza, ksubpoliza,kcertificado,koficont, kmodext, ctipoprovi);
	}
