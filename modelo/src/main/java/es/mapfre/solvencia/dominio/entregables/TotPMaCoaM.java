...
@Portable
public class TotPMaCoaM implements EntidadBase<TotPMaCoaMKey>, EntidadConBaseTec {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TotPMaCoaM other = (TotPMaCoaM) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
	...
	@Override
	public TotPMaCoaMKey getKey() {
		return new TotPMaCoaMKey(bt, fcierre,kpoliza, ksubpoliza, nsuscri);
	}
