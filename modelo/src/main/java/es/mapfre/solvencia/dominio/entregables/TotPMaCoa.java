...
@Portable
public class TotPMaCoa implements EntidadBase<TotPMaCoaKey>, EntidadConBaseTec {
	...
	@Override
	public TotPMaCoaKey getKey() {
		return new TotPMaCoaKey(bt, fcierre,kpoliza, ksubpoliza, nsuscri);
	}
