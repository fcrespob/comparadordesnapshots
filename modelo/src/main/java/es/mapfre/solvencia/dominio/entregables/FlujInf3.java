...
@Portable
public class FlujInf3 implements EntidadBase<FlujInf3Key>, EntidadConBaseTec {
	...
	public static final int IND_FDESDE = 8;
	public static final int IND_FHASTA = 9;
	public static final int IND_TOT_FP_VIDA = 10;
	public static final int IND_TOT_FP_FALL = 11;
	public static final int IND_TOT_FP_GASTOS = 12;
	public static final int IND_TOT_FP_COMISIONES = 13;
	public static final int IND_TOT_FP_RESCATES = 14;
	public static final int IND_TOT_FP_COMPL = 15;
	public static final int IND_TOT_FP_PRIMAS = 16;
	...
	public String toString() {
		return "FlujInf3 [bt=" + bt + ", fcierre=" + fcierre + ", ccanal=" + ccanal + ", negocio=" + negocio + ", uoa="
				+ uoa + ", kcarteraContrato=" + kcarteraContrato + ", kcarteraCohort=" + kcarteraCohort
				+ ", kcarteraOner=" + kcarteraOner + ", fdesde=" + fdesde + ", fhasta=" + fhasta + ", totFpVida="
				+ totFpVida + ", totFpFall=" + totFpFall + ", totFpGastos=" + totFpGastos + ", totFpComisiones="
				+ totFpComisiones + ", totFpRescates=" + totFpRescates + ", totFpCompl=" + totFpCompl + ", totFpPrimas="
				+ totFpPrimas + ", totFpGtoAd=" + totFpGtoAd + "]";
	}

	@Override
	public FlujInf3Key getKey() {
		return new FlujInf3Key(bt, fcierre, ccanal, negocio, uoa, kcarteraContrato, kcarteraCohort, kcarteraOner,
				fdesde, fhasta);
	}
}
