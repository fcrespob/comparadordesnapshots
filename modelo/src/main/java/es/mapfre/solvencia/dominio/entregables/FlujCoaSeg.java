...
@Portable
public class FlujCoaSeg implements EntidadBase<FlujCoaSegKey>, EntidadConBaseTec {
	...
	public static final int IND_GESTIONIT = 10;
	public static final int IND_KPOLIZA = 11;
	public static final int IND_KSUBPOLIZA = 12;
	public static final int IND_NSUSCRI = 13;
	public static final int IND_FINISUSC = 14;
	public static final int IND_FECFINTRAMO1 = 15;
	public static final int IND_PINTERTECN1 = 16;
	public static final int IND_DURTRCASADO = 17;
	public static final int IND_PINTERTECN2 = 18;
	public static final int IND_TABLA1 = 19;
	public static final int IND_PGASTGESIN1 = 20;
	public static final int IND_PGASTGESIN2 = 21;
	public static final int IND_FACTOR1 = 22;
	public static final int IND_GASTREALUNITARIO = 23;
	public static final int IND_GASTREAL = 24;
	public static final int IND_IPC = 25;
	public static final int IND_FECDESDE = 26;
	public static final int IND_NVECES = 27;
	public static final int IND_TOTFLUJOPROBSINGASTOS = 28;
	public static final int IND_TOTFLUJOPROBDEGASTOS = 29;
	public static final int IND_TOTFLUJONOMDEGASTOS = 30;
	...
	@PortableProperty(IND_NVECES)
	private Integer nveces;
	@PortableProperty(value = IND_TOTFLUJOPROBSINGASTOS, codec = BigDecimalSolvenciaCodec.class)
	private BigDecimal totflujoprobsingastos;
	@PortableProperty(value = IND_TOTFLUJOPROBDEGASTOS, codec = BigDecimalSolvenciaCodec.class)
	private BigDecimal totflujoprobdegastos;
	@PortableProperty(value = IND_TOTFLUJONOMDEGASTOS, codec = BigDecimalSolvenciaCodec.class)
	private BigDecimal totflujonomdegastos;
	...
	public void setNveces(Integer nveces) {
		this.nveces = nveces;
	}
	...
	public BigDecimal getTotflujonomdegastos() {
		return totflujonomdegastos;
	}
	...
	public void setTotflujonomdegastos(BigDecimal totflujonomdegastos) {
		this.totflujonomdegastos = totflujonomdegastos;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((nveces == null) ? 0 : nveces.hashCode());
		...
		result = prime * result + ((totflujonomdegastos == null) ? 0 : totflujonomdegastos.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FlujCoaSeg other = (FlujCoaSeg) obj;
		if (bt == null) {
			if (other.bt != null)
				return false;
		...
		if (nsuscri == null) {
			...
			return false;
		if (nveces == null) {
			if (other.nveces != null)
				return false;
		} else if (!nveces.equals(other.nveces))
			return false;
		if (pgastgesin1 == null) {
		...
		if (tiposubriesgo == null) {
			...
			return false;
		if (totflujonomdegastos == null) {
			if (other.totflujonomdegastos != null)
				return false;
		} else if (!totflujonomdegastos.equals(other.totflujonomdegastos))
			return false;
	...
	public String toString() {
		return "FlujCoaSeg [bt=" + bt + ", feccierre=" + feccierre + ", cnegocio=" + cnegocio + ", ccanal=" + ccanal
				+ ", kramo=" + kramo + ", kmodalidad=" + kmodalidad + ", segmento1="
				+ segmento1 + ", tiposubriesgo=" + tiposubriesgo + ", kcarterainv=" + kcarterainv + ", gapact=" + gapact
				+ ", gestionit=" + gestionit + ", kpoliza=" + kpoliza + ", ksubpoliza=" + ksubpoliza + ", nsuscri="
				+ nsuscri + ", finisusc=" + finisusc + ", fecfintramo1=" + fecfintramo1 + ", pintertecn1=" + pintertecn1
				+ ", durtrcasado=" + durtrcasado + ", pintertecn2=" + pintertecn2 + ", tabla1=" + tabla1
				+ ", pgastgesin1=" + pgastgesin1 + ", pgastgesin2=" + pgastgesin2 + ", factor1=" + factor1
				+ ", gastrealunitario=" + gastrealunitario + ", gastreal=" + gastreal
				+ ", ipc=" + ipc + ", fecdesde=" + fecdesde + ", nveces=" + nveces + ", totflujoprobsingastos="
				+ totflujoprobsingastos + ", totflujoprobdegastos=" + totflujoprobdegastos + ", totflujonomdegastos="
				+ totflujonomdegastos + ", kcuadro=" + kcuadro + ", kcoase1=" + kcoase1 + ", kcoase2=" + kcoase2
	...
	@Override
	public FlujCoaSegKey getKey() {
		return new FlujCoaSegKey(bt, feccierre, cnegocio, ccanal, gapact, kramo, kmodalidad, segmento1, tiposubriesgo, kcarterainv, kpoliza, ksubpoliza, nsuscri, fecdesde, gestionit, tabla1);
	}
