 ...
 * 
 */
public class EntregableFLUJPMACOA extends EntregableGenerico {

	final IAlmacenarDatos servicio = FachadaServicios.getAlmacenarDatos();

	private static final Logger LOG = LoggerFactory.getLogger(EntregableFLUJPMACOA.class);
	...
	public String getNombreEntregable() {
		return ConstantsFactorias.ENTREGABLE_FLUJPMACOA;
	}
	...
	/**
	 * Mapea cada entrada de los resultados a la cache flujpmacoa
	 * 
	 * @param flujosTotP
	 * @param entry
	 * @return
