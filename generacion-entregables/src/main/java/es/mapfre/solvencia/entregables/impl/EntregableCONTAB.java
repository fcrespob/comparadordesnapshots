 ...
 * 
 */
public class EntregableCONTAB extends EntregableGenerico {
	...
	public String getNombreEntregable() {
		return ConstantsFactorias.ENTREGABLE_CONTAB;
	}
...
//FIN-TAR00393113
	...
	private void transformAndStoreResults(String kbasetec, Map<Object, Object> aggregationResults,
		...
		List<Contabilidad> contabilidades = new ArrayList<Contabilidad>();
...
//FIN-823544			
			...
			if (contabilidades.size() > 0 && contabilidades.size()% 1000 == 0) {
				servicioAlmacenar.almacenarEntregableContabilidad(contabilidades);
