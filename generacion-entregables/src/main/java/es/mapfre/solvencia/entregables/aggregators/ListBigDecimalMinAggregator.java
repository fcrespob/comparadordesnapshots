...
/**
 * Calcula el valor mínimo de un set de entradas formado por List<Bigdecimal>
 * para los valores contenidos en la posición i.
 * 
 */
public class ListBigDecimalMinAggregator extends ComparableMin {

	private static final long serialVersionUID = 6691172776853937574L;
	 ...
	 * 
	 */
	public ListBigDecimalMinAggregator() {
		super();
	}
	 ...
	 * @param extractor
	 */
	public ListBigDecimalMinAggregator(Integer index, ValueExtractor extractor) {
