 ...
 *
 */
public class ListBigDecimalAverageAggregator extends BigDecimalAverage {
	 ...
	 * 
	 */
	public ListBigDecimalAverageAggregator() {
		super();
	}
	 ...
	 * @param extractor
	 */
	public ListBigDecimalAverageAggregator(Integer index, ValueExtractor extractor) {
	...
	protected void processEntry(BinaryEntry entry) {
		...
		if (value.size() >= index + 1 && value.get(index) != null) {
			process(ensureBigDecimal(value.get(index)), false);
		}
	...
	public void readExternal(PofReader arg0) throws IOException {
		...
		this.index = arg0.readInt(ConstantsFunciones.CTE_10);
	...
	public void writeExternal(PofWriter arg0) throws IOException {
		...
		arg0.writeInt(ConstantsFunciones.CTE_10, this.index);
