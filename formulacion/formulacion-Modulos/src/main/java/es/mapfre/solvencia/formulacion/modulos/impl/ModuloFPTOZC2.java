 ...
 *
 */
public class ModuloFPTOZC2 implements Modulo {

	/**
	 * Cte para log.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(ModuloFPTOZC2.class);

	// Inicio de las variables estáticas para agilizar operaciones.
	private static final String CLAVE_MODULO = ConstantsFactorias.MODULO_FPTOZC2;
	...
	public Object execute(final Object... args) throws Solvencia2Excepcion {
		...
		try {
			if (ModuloFPTOZC2.LOG.isTraceEnabled()) {
				ModuloFPTOZC2.LOG.trace("Inicio de execute en clase FPTOZC");
			}
			...
			resultado = moduloFPTOZC2(proyUmic, bloqueCorriente, iteracion, fcalc, umic, btcUmic, mapVariables, codSubproceso);
			
		} catch (Solvencia2Excepcion e) {
			ModuloFPTOZC2.LOG.error(e.getIncidencia().getTextoError(), e);
			throw e;
		} catch (Exception e) {
			ModuloFPTOZC2.LOG.error(e.getMessage(), e);
			throw Solvencia2ExcepcionHelper.crearExcepcion(ConstantsFunciones.CTE_COD_ERROR_000, null, e);
		}
		
		if (ModuloFPTOZC2.LOG.isTraceEnabled()) {
			ModuloFPTOZC2.LOG.trace("Fin de execute en clase FPTOZC");
		}
	 ...
	 */
	private BigDecimal moduloFPTOZC2(final List<DetalleCorriente> proyUmic, final BloqueCorriente bloqueCorriente, final Integer iteracion,
		...
		if (ModuloFPTOZC2.LOG.isTraceEnabled()) {
			ModuloFPTOZC2.LOG.trace("Inicio función << moduloFPTOZC >> de la clase moduloFPTOZC, para la iteracion = {}", iteracion);
		}
...
//FIN-TAR00400971
		...
		if (ModuloFPTOZC2.LOG.isTraceEnabled()) {
			ModuloFPTOZC2.LOG.trace("Fin función << moduloFPTOZC >> de la clase moduloFPTOZC, para la iteracion = {}, con resultado fptozc = {}", iteracion, fptozc);
		}
