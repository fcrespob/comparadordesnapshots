...
/**
 * Módulo que calculará VZC de viudedad tomando el conyuge
 * @author 
 *
 */
public class ModuloVZC2 implements Modulo {

	/**
	 * Cte para log.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(ModuloVZC2.class);
	
	// Inicio de las variables estáticas para agilizar operaciones.
	private static final String CLAVE_MODULO = ConstantsFactorias.MODULO_VZC2;
	...
	public Object execute(final Object... args) throws Solvencia2Excepcion {
		...
		try {
			if (ModuloVZC2.LOG.isTraceEnabled()) {
				ModuloVZC2.LOG.trace("Inicio de execute en clase VZC2");
			}
			...
			//Invocamos a la función moduloVZC2
			resultado = moduloVZC2(proyUmic, bloqueCorriente, iteracion, fcalc, umic, btcUmic, codSubproceso ,mapVariables);
			
		} catch (Solvencia2Excepcion e) {
			ModuloVZC2.LOG.error(e.getIncidencia().getTextoError(), e);
			throw e;
		} catch (Exception e) {
			ModuloVZC2.LOG.error(e.getMessage(), e);
			throw Solvencia2ExcepcionHelper.crearExcepcion(ConstantsFunciones.CTE_COD_ERROR_000, null, e);
		}
		
		if (ModuloVZC2.LOG.isTraceEnabled()) {
			ModuloVZC2.LOG.trace("Fin de execute en clase VZC2");
		}

		return resultado;
	}
	/**
	 * Módulo que calculara VZC tomando el conyuge.
	 *
	 * @param proyUmic
	 ...
	 */
	private BigDecimal moduloVZC2(List<DetalleCorriente> proyUmic, BloqueCorriente bloqueCorriente, int iteracion,
		...
		if (ModuloVZC2.LOG.isTraceEnabled()) {
			ModuloVZC2.LOG.trace("Inicio función << moduloVZC2 >> de la clase moduloVZC2, para la iteracion = {}", iteracion);
		}
		...
		if (null == umic.getAsegurados().getFnacAseg2() || null == umic.getAsegurados().getCsexAseg2() ||
			...
			if(null == varUmic2){
				...
				try {
					...
					ModuloVZC2.LOG.error(e.getMessage());
				}
		...
		if (ModuloVZC2.LOG.isTraceEnabled()) {
			ModuloVZC2.LOG.trace("Fin función << moduloVZC2 >> de la clase ModuloVZC2, para la iteracion = {}, con resultado VZC2 = {}", iteracion, VZC2);
		}
