...
public class ModuloGZC504 implements Modulo {

	/**
	 * Cte para log.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(ModuloGZC504.class);
	private static final String CLAVE_MODULO = ConstantsFactorias.MODULO_GZC504;
	...
	public String getNombreServicio() {
		return ConstantsFactorias.MODULO_GZC504;
	}
	...
	public Object execute(final Object... args) throws Solvencia2Excepcion {
		...
		try {
			if (ModuloGZC504.LOG.isTraceEnabled()) {
				ModuloGZC504.LOG.trace("Inicio de execute en clase ModuloGZC504");
			}
			...
			ModuloGZC504.LOG.error(e.getIncidencia().getTextoError(), e);
			throw e;
		} catch (Exception e) {
			ModuloGZC504.LOG.error(e.getMessage(), e);
			throw Solvencia2ExcepcionHelper.crearExcepcion(ConstantsFunciones.CTE_COD_ERROR_000, null, e);
		}
		
		if (ModuloGZC504.LOG.isTraceEnabled()) {
			ModuloGZC504.LOG.trace("Fin de execute en clase ModuloGZC504");
		}
	...
	private BigDecimal moduloGZC504(List<DetalleCorriente> proyUmic, BloqueCorriente bloqueCorriente, int iteracion,
		...
		BigDecimal gzc504 = BigDecimal.ZERO;
		Timestamp varFechaEfecto = null;
		Timestamp varFecEfecFin = null;
		Integer varTCm = 0, varTtm = 0;
		
		if (ModuloGZC504.LOG.isTraceEnabled()) {
			ModuloGZC504.LOG.trace("Inicio función << moduloGZC504 >> de la clase ModuloGZC504, para la iteracion = {}", iteracion);
		}
		...
		gzc504 = umic.getCapitales().getIsaldo().divide(new BigDecimal(varTtm-varTCm),ConstantsFunciones.MATH_CONTEXT);
				
		if (ModuloGZC504.LOG.isTraceEnabled()) {
			ModuloGZC504.LOG.trace("Fin función << moduloGZC504 >> de la clase ModuloGZC504, para la iteracion = {} con resultado gzc504 = {}", iteracion, gzc504);
		}
