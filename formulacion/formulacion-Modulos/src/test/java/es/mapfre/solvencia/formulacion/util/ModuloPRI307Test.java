...
/**
 * Clase que testea el Módulo PRI307
 * @author ogperez
 *
 */

public class ModuloPRI307Test{
	
	private static final Logger LOG = LoggerFactory.getLogger(ModuloPRI307Test.class);
	...
	private static final Timestamp FDEVENGO = new Timestamp(new GregorianCalendar(2016, 00, 01, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0).getTimeInMillis());
	private static final Timestamp FPAGO = new Timestamp(new GregorianCalendar(2016, 00, 01, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0).getTimeInMillis());
	...
	public static void init() {
		ModuloPRI307Test.LOG.debug("Inicializando pruebas");
		...
		try{
			...
			ModuloPRI307Test.LOG.debug(e.getMessage(), e);
			fail();
		}
	}
	
	@Test
	public void moduloPRI307Test(){
		Modulo moduloPRI307 = FactoriaModulos.getModulo(ConstantsFactorias.MODULO_PRI307);
				
		try{
			BigDecimal pri307 = (BigDecimal) moduloPRI307.execute(getProyUmic(), getBloqueCorriente(), iteracion, FCALC, getUmic(), getBtcUmic(), mapVariables, codigoSubproceso);
		
			//System.out.println(pri307);

			TestCase.assertEquals(BigDecimal.valueOf(5479.3742), pri307.setScale(4, RoundingMode.HALF_DOWN));
		}catch (Exception e){
			ModuloPRI307Test.LOG.debug(e.getMessage(), e);
			fail();
		}
	...
	private Umic getUmic(){
		...
		Timestamp fecefecfin = new Timestamp(new GregorianCalendar(2022, 00, 01, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0).getTimeInMillis());
		...
		Timestamp fecdesderenova = new Timestamp(new GregorianCalendar(2015, 00, 01, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0).getTimeInMillis());
		Timestamp fechastarenova = new Timestamp(new GregorianCalendar(2016, 00, 01, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0, ConstantsFunciones.CTE_0).getTimeInMillis());
...
//		datosGenerales.setCtipoaport("U");
		...
		datosGenerales.setTipoflexprim("A");
