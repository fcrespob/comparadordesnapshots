...
/**
 * Clase que testea el Módulo VRTA167, módulo de cálculo que devuelve los factores de probabilización a aplicar en  el 
 * cálculo de la cuantía probable de la garantía.
 * @author apedro
 *
 */

public class ModuloVRTA167Test{
	
	private static final Logger LOG = LoggerFactory.getLogger(ModuloVRTA167Test.class);
	...
	public static void init() {
		ModuloVRTA167Test.LOG.debug("Inicializando pruebas");
		...
		try{
			...
			ModuloVRTA167Test.LOG.debug(e.getMessage(), e);
			fail();
		}
	}
	
	@Test
	public void moduloVRTA167Test(){
		Modulo moduloVRTA167 = FactoriaModulos.getModulo(ConstantsFactorias.MODULO_VRTA167);
				
		try{
			BigDecimal vrta167 = (BigDecimal) moduloVRTA167.execute(getProyUmic(), getBloqueCorriente(), iteracion, FCALC, getUmic(), getBtcUmic(), mapVariables, codigoSubproceso);

			TestCase.assertEquals(BigDecimal.valueOf(0.98044738765), vrta167.setScale(11, RoundingMode.HALF_DOWN));
		}catch (Exception e){
			ModuloVRTA167Test.LOG.debug(e.getMessage(), e);
			fail();
		}
