...
public class TestProgramaPRV001 {

	private static final Logger LOG = LoggerFactory.getLogger(TestProgramaPRV001.class);
	...
	public static void end() {
		TestProgramaPRV001.LOG.debug("Fin pruebas del programa PRV001");
	}
	
	@SuppressWarnings("unchecked")
	@BeforeClass
	public static void init() {
		TestProgramaPRV001.LOG.debug("Inicio pruebas del programa PRV001");
		try {
			...
			TestProgramaPRV001.LOG.debug(e.getMessage(),e);
		} catch (Throwable e) {
			TestProgramaPRV001.LOG.debug(e.getMessage(),e);
		}
	}
	...
	public void test() {
		...
		TestProgramaPRV001.LOG.debug("Inicio programa PRV001");
		...
		TestProgramaPRV001.LOG.debug("Fin programa PRV001");
	}
}
