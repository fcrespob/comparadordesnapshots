...
public class TestProgramaFEC001 {

	private static final Logger LOG = LoggerFactory.getLogger(TestProgramaFEC001.class);
	...
	public static void end() {
		TestProgramaFEC001.LOG.debug("Fin pruebas del programa FEC001");
	}
	
	@SuppressWarnings("unchecked")
	@BeforeClass
	public static void init() {
		TestProgramaFEC001.LOG.debug("Inicio pruebas del programa FEC001");
		try {
			...
			TestProgramaFEC001.LOG.debug(e.getMessage(),e);
		} catch (Throwable e) {
			TestProgramaFEC001.LOG.debug(e.getMessage(),e);
		}
	}
	...
	public void test() {
		...
		TestProgramaFEC001.LOG.debug("Inicio programa FEC001");
		try {
		...
		TestProgramaFEC001.LOG.debug("Fin programa FEC001");
	}
}
