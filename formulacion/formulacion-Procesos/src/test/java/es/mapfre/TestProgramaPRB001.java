...
public class TestProgramaPRB001 {

	private static final Logger LOG = LoggerFactory.getLogger(TestProgramaPRB001.class);
	...
	public static void end() {
		TestProgramaPRB001.LOG.debug("Fin pruebas del programa PRB001");
	}
	
	@SuppressWarnings("unchecked")
	@BeforeClass
	public static void init() {
		TestProgramaPRB001.LOG.debug("Inicio pruebas del programa PRB001");
		try {
			...
			TestProgramaPRB001.LOG.debug(e.getMessage(),e);
		} catch (Throwable e) {
			TestProgramaPRB001.LOG.debug(e.getMessage(),e);
		}
	}
	...
	public void test() {
		...
		TestProgramaPRB001.LOG.debug("Inicio programa PRB001");
		try {
		...
		TestProgramaPRB001.LOG.debug("Fin programa PRB001");
	}
}
