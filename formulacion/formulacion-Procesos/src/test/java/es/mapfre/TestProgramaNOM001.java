...
public class TestProgramaNOM001 {
	
	private static final Logger LOG = LoggerFactory.getLogger(TestProgramaNOM001.class);
	...
	public static void end() {
		TestProgramaNOM001.LOG.debug("Fin pruebas del programa NOM001");
	}
	
	@SuppressWarnings("unchecked")
	@BeforeClass
	public static void init() {
		TestProgramaNOM001.LOG.debug("Inicio pruebas del programa NOM001");
		try {
			...
			TestProgramaNOM001.LOG.debug(e.getMessage(),e);
		} catch (Throwable e) {
			TestProgramaNOM001.LOG.debug(e.getMessage(),e);
		}
	}	
	...
	public void test() {
		...
		TestProgramaNOM001.LOG.debug("Inicio programa NOM001");
		try {
		...
		TestProgramaNOM001.LOG.debug("Fin programa NOM001");
	}
}
