...
public class TestProgramaPMC001 {

	private static final Logger LOG = LoggerFactory.getLogger(TestProgramaPMC001.class);
	...
	public static void end() {
		TestProgramaPMC001.LOG.debug("Fin pruebas del programa PMC001");
	}
	
	@SuppressWarnings("unchecked")
	@BeforeClass
	public static void init() {
		TestProgramaPMC001.LOG.debug("Inicio pruebas del programa PMC001");
		try {
			...
			TestProgramaPMC001.LOG.debug(e.getMessage(),e);
		} catch (Throwable e) {
			TestProgramaPMC001.LOG.debug(e.getMessage(),e);
		}
	}
	
	//TODO: Descomentar la anotación cuando esten revisados los módulos de formula cerrrada
	//@Test
	public void test() {
		Umic umic = null;
		List<DetalleCorriente> lstDetCorriente = null;
		
		TestProgramaPMC001.LOG.debug("Inicio programa PMC001");
		try {
		...
		TestProgramaPMC001.LOG.debug("Fin programa PMC001");
	}
}
