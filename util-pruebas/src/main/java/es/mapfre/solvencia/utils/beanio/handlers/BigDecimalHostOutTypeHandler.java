...
public class BigDecimalHostOutTypeHandler implements TypeHandler, ConfigurableTypeHandler {
	...
	public TypeHandler newInstance(Properties arg0) {
		BigDecimalHostOutTypeHandler ddth = new BigDecimalHostOutTypeHandler();
